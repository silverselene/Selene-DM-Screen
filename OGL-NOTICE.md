# Third-Party Content Notice (Open Gaming License & Creative Commons)

Portions of this project's monster dataset
([artifacts/dm-screen/src/data/monsters.ts](artifacts/dm-screen/src/data/monsters.ts))
are derived from Open Game Content — stat blocks from Kobold Press's *Tome of
Beasts*, *Tome of Beasts 2*, *Tome of Beasts 3*, and *Creature Codex*, and
from EN Publishing's *Level Up: Advanced 5th Edition Monstrous Menagerie*.

Portions of this project's compendium dataset
([artifacts/dm-screen/src/data/compendiumRules.ts](artifacts/dm-screen/src/data/compendiumRules.ts))
are similarly derived from Open Game Content — feats from Kobold Press's
*Tome of Heroes* and Green Ronin's *Critical Role: Tal'Dorei Campaign
Setting* — and, separately, from EN Publishing's *Level Up: Advanced 5th
Edition System Reference Document* (A5ESRD), which is Creative Commons
Attribution 4.0 licensed rather than OGL.

All of the above were retrieved via the [Open5e](https://open5e.com)
project's structured data (`open5e/open5e-api`, pinned to tag `v1.12.0`).
The OGL-licensed material is used under the Open Gaming License Version
1.0a reproduced below; the A5ESRD material is used under CC BY 4.0
(https://creativecommons.org/licenses/by/4.0/legalcode), which requires
only attribution — reproduced in the Copyright Notice section below
alongside the OGL Section 15 notices.
...
Richard Green, James Haeck, Chris Harris, Jeremy Hochhalter, James
...
Level Up: Advanced 5th Edition Monstrous Menagerie. Copyright 2021, EN
Publishing.

Tome of Heroes. Copyright 2022, Open Design; Authors Kelly Pawlik, Ben
Mcfarland, and Brian Suskind.

Critical Role: Tal'Dorei Campaign Setting is © 2017 Green Ronin Publishing,
LLC. All rights reserved.

## Creative Commons Attribution 4.0 Notice

This work includes material taken from the A5E System Reference Document
(A5ESRD) by EN Publishing and available at A5ESRD.com, based on Level Up:
Advanced 5th Edition, available at www.levelup5e.com. The A5ESRD is
licensed under the Creative Commons Attribution 4.0 International License
available at https://creativecommons.org/licenses/by/4.0/legalcode.

## Full License Text (OGL v1.0a)
...
15. COPYRIGHT NOTICE: see "Section 15: Copyright Notice" above.
