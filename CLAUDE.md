...
| Compendium (bulk rules) | `src/data/compendiumRules.ts` | 562 | 5etools `data/{feats,actions,skills,senses,variantrules}.json` + Open5e `data/v1/{a5e,toh,taldorei}/Feat.json` (OGL/CC-BY) |
